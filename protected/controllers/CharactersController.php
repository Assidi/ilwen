...
class CharactersController extends Controller
{
	...
	{
		$character = $this->loadModel($id);
        $this->pageTitle = Yii::app()->name.' - '.$character->name;
	...
	public function actionCreate()
	{
        ...
        $this->pageTitle = Yii::app()->name.' -  Новый персонаж';
	...
	{
		$this->pageTitle = Yii::app()->name.' -  Персонажи';
	...
	public function actionAdmin()
	{
        ...
        $this->pageTitle = Yii::app()->name.' -  Управление персонажами';

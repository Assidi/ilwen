...
class GenresController extends Controller
{
	...
	{
		$genre = $this->loadModel($id);
        $this->pageTitle = Yii::app()->name.' - '.$genre->name;
	...
	{
		$model=new Genres;
        $this->pageTitle = Yii::app()->name.' -  Новый жанр';
	...
	{
		$this->pageTitle = Yii::app()->name.' -  Жанры';
	...
	public function actionAdmin()
	{
        ...
        $this->pageTitle = Yii::app()->name.' -  Управление жанрами';

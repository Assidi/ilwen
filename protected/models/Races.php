...
class Races extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'racestexts' => array(self::HAS_MANY, 'Racestext', 'raceid'),
		);
	}
    ...
    /**
	 * Получение народов для показа в выпадающем списке
	 * @return $arlist
	 */
    ...
    /**
	 * Получение модели отображения народа
	 * @return $modelrace
	 */
    
    public static function getRace($id) {  
        $r = new Races;
        $modelrace = $r->findByPk($id);
        return $modelrace;  
    }
}
